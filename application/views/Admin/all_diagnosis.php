...
<div class="container container-fluid col-md-8 col-md-offset-2">
    <div>
        <table class="table table-striped table-active table-bordered" id="diagnosisTable">
            <thead>
              <td>ID</td>
              <td>Diagnosis For (patient)</td>
              <td>Diagnosis By (doctor)</td>
            ...
            <?php foreach ($myDiagnosis as $diagnosis): ?>
                <tr>
                    ...
                    <td><?php echo getDoctor($diagnosis->appointment_id); ?></td>
                    ...
                    <td><a class="btn btn-primary" href="<?php echo base_url('AdminController/getScans/').$diagnosis->appointment_id; ?>">See Scans</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
