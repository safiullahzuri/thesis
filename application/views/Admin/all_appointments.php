        ...
        <table class="table table-striped table-active table-bordered" id="appointmentsTable">
            ...
            <?php foreach ($appointments as $appointment): ?>
                <tr>
                    ...
                    <td><?php echo getPatientsNameFromAppointment($appointment->app_id); ?></td>
                    <td><?php echo $appointment->description; ?></td>
                    <td><?php echo $appointment->sdate; ?></td>
                    <td><?php echo $appointment->ptime; ?></td>
                    <td> <?php if($appointment->display == 'no'):  ?>
                            <a class="btn btn-info" href="<?php echo base_url(); ?>AdminController/getScans/<?php echo $appointment->app_id; ?>">See Scans</a>
                        <?php else: ?>
                            <span class="info">Not Examined</span>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
